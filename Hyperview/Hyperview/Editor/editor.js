...
3. "-" cannot repeat`);
  ...
  var ITEMS = [
    ...
    {
      title: "Table",
      hint: "3\xD73 table with header row",
    ...
    {
      title: "Link to file",
      hint: "Link to a file on this Mac",
