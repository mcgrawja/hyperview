...
extension Notification.Name {
    ...
    static let hyperviewOpenChat = Notification.Name("hyperview.openChat")
    static let hyperviewOpenReminder = Notification.Name("hyperview.openReminder")
    static let hyperviewOpenCalendarDate = Notification.Name("hyperview.openCalendarDate")
}
        ...
        return notes
            ...
            .map { note in
                SearchHit(
                    ...
                    notification: (.hyperviewOpenNote, ["id": note.id])
                )
            }
    }
        ...
        return messages
            ...
            .map { message in
                SearchHit(
                    ...
                    notification: (.hyperviewOpenMailMessage, ["id": message.id])
                )
            }
    }
    ...
    private func searchEvents(_ text: String) async -> [SearchHit] {
        ...
        return events.map { event in
            SearchHit(
                ...
                notification: (.hyperviewOpenCalendarDate, ["date": event.start])
            )
        }
    }
    ...
    private func searchReminders(_ text: String) async -> [SearchHit] {
        ...
        return reminders.map { reminder in
            SearchHit(
                ...
                notification: (.hyperviewOpenReminder, ["id": reminder.id])
            )
        }
    }
        ...
        return chats
            ...
            .map { chat in
                SearchHit(
                    ...
                    notification: (.hyperviewOpenChat, ["id": chat.id])
                )
            }
    }
    #endif
