...
//  Unifyr
//
//  Unifyr as the single notification hub: the user silences Apple's Mail /
//  Reminders / Calendar / Messages and lets Unifyr surface everything. Each
...
/// The kinds of thing Unifyr notifies about. `symbol`/`tint` drive the
...
extension Notification.Name {
    ...
    static let unifyrOpenModule = Notification.Name("unifyr.openModule")
}
...
final class NotificationService: NSObject, UNUserNotificationCenterDelegate {
    ...
    /// Show banners even while Unifyr is frontmost.
    ...
    nonisolated func userNotificationCenter(
        ...
        Task { @MainActor in
            ...
            if let module {
                NotificationCenter.default.post(name: .unifyrOpenModule, object: nil, userInfo: ["module": module])
            }
        }
    }
}
